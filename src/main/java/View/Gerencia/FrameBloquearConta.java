...
import Control.Gerencia.ControlBloquearConta;
 ...
 */
public class FrameBloquearConta extends javax.swing.JFrame {
...
//    private Map<Integer, Map<String, ArrayList<String>>> bdClientes;
    ...
    /**
     * Creates new form FrameBloquearConta
     */
    public FrameBloquearConta() {
        initComponents();
    }
    ...
    public void resetBloquear() {
        bloquear.setEnabled(false);
    }

    public void preencherNomesClientes() {
        // Limpa os campos
        ControlBloquearConta.limparCampos(this);
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Bloquear uma Conta");
                            ...
                            .addGroup(PainelPrincipal6Layout.createSequentialGroup()
                                .addGroup(PainelPrincipal6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(PainelPrincipal6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(PainelPrincipal6Layout.createSequentialGroup()
                                            .addGap(36, 36, 36)
                                            .addComponent(bloquear, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        PainelPrincipal6Layout.setVerticalGroup(
            ...
            .addGroup(PainelPrincipal6Layout.createSequentialGroup()
                ...
                .addGroup(PainelPrincipal6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bloquear, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(56, 56, 56))
        );
    ...
    private void btnbloquearclick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnbloquearclick
        // TODO add your handling code here:
    }//GEN-LAST:event_btnbloquearclick
    ...
    private void bloquearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bloquearActionPerformed
        ...
        boolean status = ControlBloquearConta.bloquear(conta, bloquear.getText());
        
        if (status) {
            if (bloquear.getText().equals("Bloquear")) {
                ControlBloquearConta.sucessoBloq();
            } else {
                ControlBloquearConta.sucessoDesbloq();
            }

            ControlBloquearConta.cancelar(this, getParentFrame());
        } else {
            ControlBloquearConta.erro();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameBloquearConta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameBloquearConta().setVisible(true);
            }
        });
    }
